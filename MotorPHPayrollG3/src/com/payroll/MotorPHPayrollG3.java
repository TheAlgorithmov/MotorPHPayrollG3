...
public class MotorPHPayrollG3 {
    public static void main (String[] args) {
        ...
        EMPID = "10021";
        EMPNAME = (EmpDB.employeeData.getOrDefault(Integer.valueOf(EMPID), "Employee not found."));
        EMPDOB = (EmpDB.empBD.getOrDefault(Integer.valueOf(EMPID), "Employee not found."));
        workedHoursWeekly = 80;
        hourlySalary = EmpDB.empTime.getOrDefault(Integer.valueOf(EMPID), 0.0);


        //Calculation of Gross Income
        grossIncome = (hourlySalary * workedHoursWeekly);
